namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "807", Name = "THE GODHRA URBAN CO-OP. BANK LTD.", AddressLine1 = "Rana Vyas Marg", City = "Godhra", State = "Gujarat", Country = "India", PostalCode = "389001", WebAddress = "", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
