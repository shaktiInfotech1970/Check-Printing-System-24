namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "808", Name = "THE UMRETH URBAN CO OP BANK LTD. HEAD OFFICE", AddressLine1 = "PANCHVATI", City = "UMRETH", State = "GUJARAT", Country = "India", PostalCode = "388220", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
