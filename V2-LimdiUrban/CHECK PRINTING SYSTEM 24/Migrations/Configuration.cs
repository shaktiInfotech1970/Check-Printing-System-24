namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "816", Name = "THE LIMDI URBAN CO - OP. BANK LTD.", AddressLine1 = "Limdi - 389 180, Dist. Dahod.", City = "Limdi", State = "Gujarat", Country = "India", PostalCode = "389180", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
