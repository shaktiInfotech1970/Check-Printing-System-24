namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "502", Name = "The Business Bank Ltd", AddressLine1 = "The Business Bank Ltd, Main Branch", AddressLine2 = "Rajan Complex Arcade", AddressLine3 = "Datt Mandir Circle, Nashik Road", City = "Nashik",  State = "Maharashtra", Country = "India", Phone= "0253-2406100", Email= "bbanknskrd@rediffmail.com", PostalCode = "422101", WebAddress = "", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
