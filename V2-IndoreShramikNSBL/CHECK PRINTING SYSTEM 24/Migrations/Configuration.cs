namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "556", Name = "SHRAMIK NAGRIK SAHAKARI BANK LTD.", AddressLine1 = "123, DEVI AHILYA MARG , SHRAM SHIVIR", City = "INDORE", State = "MP", Country = "India", PostalCode = "452003", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
