            ...
            foreach(var each in assingPrintJobRequests)
{
        ...
        private static void PrintRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            if (BatchInPrinting.RequestLayout.branchAddress2Visble)
                e.Graphics.DrawString(string.Format("{0} BR.", section.PrintRequest.Branch.Name), font9Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress2X + 3f), y + GetDPI(BatchInPrinting.RequestLayout.branchAddress2Y - 1.5f));
