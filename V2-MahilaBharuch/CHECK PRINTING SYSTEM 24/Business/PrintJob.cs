...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        {
            var installationDate = new DateTime(2026, 12, 1);
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            if (BatchInPrinting.ChequeLayout.branchAddressVisble)
                e.Graphics.DrawString(GetBranchAddress1(section.PrintRequest.Branch), font7, brush, x + GetDPI(BatchInPrinting.ChequeLayout.branchAddressX), y + GetDPI(BatchInPrinting.ChequeLayout.branchAddressY));
