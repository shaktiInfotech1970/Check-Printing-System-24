...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            {
                RectangleF stampRect = new RectangleF(x, y + GetDPI(BatchInPrinting.ChequeLayout.custom1Y), 800, 10);
                StringFormat stringFormat = new StringFormat();
            ...
            {
                if (IsPayOrder(section.PrintRequest.Request.TransactionCode) && section.PrintRequest.Request.BearerOrder.ToLower() != "order")
            ...
            {
                RectangleF stampRect = new RectangleF(x, y + GetDPI(BatchInPrinting.ChequeLayout.custom2Y), 800, 11);
                StringFormat stringFormat = new StringFormat();
                stringFormat.Alignment = StringAlignment.Center;
                stringFormat.LineAlignment = StringAlignment.Center;
                e.Graphics.DrawString("Not Over RS._______________", font9Bold, brush, stampRect, stringFormat);
            }
