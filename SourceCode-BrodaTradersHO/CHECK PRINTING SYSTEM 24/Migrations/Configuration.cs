namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "154", Name = "The Baroda Traders Co - Op. Bank Ltd.", AddressLine1 = "Hathikhana Branch : Hathikhana Market Yard, Fathepura", City = "Vadodara", State = "Gujarat", Country = "India", PostalCode = "390006", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
