...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static string GetBranchAddress(PrintRequest request)
        {
            ...
            if (request.Branch.Code == "002" && request.Request.TransactionCode == 12)
            {
        ...
        private static string GetBranchAddress1(BranchMasterDTO branch)
        {
            ...
            if (!string.IsNullOrWhiteSpace(branch.Name))
                sb.Append("SHRI MAHESH CO-OP. BANK LTD., NASHIK");
        ...
        private static void PrintRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            PrintNameAddress(e, section.PrintRequest.Request, x + GetDPI(0.7f), y + GetDPI(4.2f), 300, 110);
            ...
            e.Graphics.DrawString("Regu. Busi.Hrs.: 10:00 AM To 05:00 PM", font6, brush, x + GetDPI(0.5f), y + GetDPI(8.9f));
            ...
            e.Graphics.DrawString("Balance Enquiry No. : 8000515054", font6, brush, x + GetDPI(0.5f), y + GetDPI(10.5f));
            /* END Left Section */
            ...
            e.Graphics.DrawString($"Contact No:{section.PrintRequest.Request.Contact1}", font7, brush, x + GetDPI(12.4f), y + GetDPI(8.8f));
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            e.Graphics.DrawString("CTS CLEARING", font9Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.accountNoX), y + GetDPI(BatchInPrinting.ChequeLayout.accountNoY + 3.5f));
