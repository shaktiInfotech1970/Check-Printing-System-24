namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "801", Name = "SHREE MORBI NAGARIK SAHAKARI BANK LTD.", AddressLine1 = "Vasant Plot, Main Road, Opp: Shree Lohana Vidhyarthi Bhavan", City = "Morbi", State = "Gujarat", Country = "India", PostalCode = "363641", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
