namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "202", Name = "Pragati Sahakari Bank Ltd", AddressLine1 = "Alembic Colony, Gorwa Road", City = "Vadodara", State = "Gujarat", Country = "India", PostalCode = "390003", WebAddress = "http://psbl.co.in", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
