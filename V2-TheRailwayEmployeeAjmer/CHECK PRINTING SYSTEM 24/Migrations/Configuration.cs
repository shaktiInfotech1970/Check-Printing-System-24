namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "211", Name = "THE RAILWAY EMPLOYEE'S CO - OP. BANK LTD.", AddressLine1 = "RAILWAY BUNGLOW NO. L 86, HAJARI BAGH, BEAWAR ROAD", City = "AJMER", State = "RAJASTHAN", Country = "INDIA", PostalCode = "305001", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
