...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static string GetStamp(RequestDTO request)
        {
            ...
            if (request.BearerOrder.ToLower() == "order")
            {
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            if (section.PrintRequest.Request.BearerOrder.ToLower() == "order" && BatchInPrinting.ChequeLayout.custom1Visible)
            {
            ...
            if (section.PrintRequest.Request.BearerOrder.ToLower() == "order" && BatchInPrinting.ChequeLayout.custom2Visible)
            {
