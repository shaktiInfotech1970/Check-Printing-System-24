    ...
    public partial class DaywiseChequePrint : UserControl
    {
        ...
        private void btnShowColumns_Click(object sender, RoutedEventArgs e)
        {
            using (var context = new CPSDbContext())
            {
                ...
                var response = query.OrderBy(ord => ord.Request.SerialNo).ToList();
        ...
        private void btnPrint_Click(object sender, RoutedEventArgs e)
        {
            ...
            ReportPDF report = new ReportPDF(dgDaywiseChequePrint, new float[] { 40, 90, 180, 30, 55, 50, 30, 110, 70, 125 },10f);
