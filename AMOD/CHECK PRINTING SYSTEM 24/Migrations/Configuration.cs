namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "805", Name = "THE AMOD NAGRIK CO-OP BANK LTD", AddressLine1 = "AT & PO: AMOD BHARUCH", City = "BHARUCH", State = "GUJARAT", Country = "India", PostalCode = "392110", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
