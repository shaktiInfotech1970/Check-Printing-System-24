namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "809", Name = "THE DAHOD MERCANTILE CO-OP BANK LTD", AddressLine1 = "POST BOX NO 58 MULLAJI BAZAR", City = "DAHOD", State = "GUJARAT", Country = "India", PostalCode = "389151", WebAddress = "", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
