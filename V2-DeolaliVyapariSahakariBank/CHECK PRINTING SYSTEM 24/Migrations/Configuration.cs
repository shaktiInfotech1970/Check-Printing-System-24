namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "374", Name = "THE NASHIK ROAD DEOLALI VYAPARI SAHAKARI BANK LTD.", AddressLine1 = "\"KALPAWRUKSHA\", ASHA NAGAR", City = "NASHIK", State = "MAHARASHTRA", Country = "India", PostalCode = "422101", WebAddress = "", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
