...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            Font font8ZeroSlashBold = new Font("Consolas", 8, FontStyle.Bold);
            Font font9Bold = new Font("Verdana", 9, FontStyle.Bold);
            Font font5 = new Font("Verdana", 5);
            ...
            if (BatchInPrinting.ChequeLayout.ifscVisble)
                e.Graphics.DrawString(string.Format("IFSC: {0}", section.PrintRequest.Branch.IFSC), font8ZeroSlashBold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.ifscX), y + GetDPI(BatchInPrinting.ChequeLayout.ifscY));
            ...
            if (BatchInPrinting.ChequeLayout.accountNoVisble)
                e.Graphics.DrawString(string.Format("{0}: {1}", section.PrintRequest.AccountType.Name, section.PrintRequest.Request.AccountNoFull), font8Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.accountNoX), y + GetDPI(BatchInPrinting.ChequeLayout.accountNoY));
