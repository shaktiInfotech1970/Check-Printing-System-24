namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "840", Name = "CHHATRAPATI RAJARSHI SHAHU URBAN CO-OP BANK LTD", AddressLine1 = "Janadhar Bhavan, Jalna Road", City = "BEED", State = "MAHARASHTRA", Country = "India", PostalCode = "431122", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
        ...
        private void SeedPermission(CPSDbContext context)
        {
            context.Permission.AddOrUpdate(new PermissionDTO { Id = 1, UserId = 1, Page = Common.Page.AccountType, Permission = 7, CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now },
                                           ...
                                           new PermissionDTO { Id = 53, UserId = 1, Page = Common.Page.ConsolidatedChequeBookPrint, Permission = 7, CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now },
                                           new PermissionDTO { Id = 54, UserId = 2, Page = Common.Page.ConsolidatedChequeBookPrint, Permission = 7, CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
