namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "802", Name = "Navsarjan Industrial Co - Op. Bank Ltd.", AddressLine1 = "Plot No. 5602 C/1 & C/14, GIDC Estate", City = "Ankleshwar", State = "Gujarat", Country = "India ", PostalCode = "393002", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
