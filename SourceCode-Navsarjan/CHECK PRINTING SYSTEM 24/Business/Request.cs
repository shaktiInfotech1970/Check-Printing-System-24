...
namespace CPS.Business
{
    ...
    public class RequestBase : BaseEntity
    {
        ...
        [Display(Name = "City", Order = 17)]
        public string City { get; set; }

        [Display(Name = "PinCode", Order = 18)]
        public string PostalCode { get; set; }

        [Display(Name = "No of ChqBook", Order = 19)]
        [Required]
        public int NoOfChequeBook { get; set; }

        [Required]
        [Display(Name = "No of Cheque", Order = 20)]
        public int NoOfCheque { get; set; }

        [Display(Name = "Bearer Order", Order = 21)]
        [Required]
        public string BearerOrder { get; set; }

        [Required]
        [Display(Name = "AtPar", Order = 22)]
        [MaxLength(1)]
