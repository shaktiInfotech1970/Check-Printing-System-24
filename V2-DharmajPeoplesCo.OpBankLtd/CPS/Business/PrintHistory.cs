...
namespace CPS.Business
{
    ...
    public class PrintHistoryDTO : BaseEntity
    {
        ...
        public static PrintHistoryDTO GetPrintHistory(int PrintJobNo, string additional_f10)
        {
            using (var context = new CPSDbContext())
            {
                ...
                var query = (from ph in repositoryPrintHistory.GetAll()
                             ...
                             where r.PrintJobNo == PrintJobNo && r.additional_f10 == additional_f10 && ph.PrintType == PrintType.ChequeBook
                             select ph
