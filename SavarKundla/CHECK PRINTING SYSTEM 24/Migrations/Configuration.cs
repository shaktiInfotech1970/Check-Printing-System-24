namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "810", Name = "SHREE SAVARKUNDLA NAGRIK SAHKARI BANK LTD.", AddressLine1 = "SAVARKUNDLA MAIN BRANCH  NADI BAZAR ", City = "SAVARKUNDLA", State = "Gujarat", Country = "India ", PostalCode = "364515", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
