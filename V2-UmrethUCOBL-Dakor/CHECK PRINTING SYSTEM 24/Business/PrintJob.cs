    ...
    public class PrintJob
    {
        ...
        private static string GetBranchAddress1(BranchMasterDTO branch)
        {
            ...
            if (!string.IsNullOrWhiteSpace(branch.Name))
                sb.Append("The Umreth Urban Co-Op. Bank Ltd.");
        ...
        private static void PrintRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            e.Graphics.DrawString(string.Format("{0}: {1}", section.PrintRequest.AccountType.Name, section.PrintRequest.Request.AccountNoFull), font7Bold, brush, x + GetDPI(1.2f), y + GetDPI(2.1f));
            PrintNameAddress(e, section.PrintRequest.Request, x + GetDPI(1.2f), y + GetDPI(2.7f), 300, 110);
            var barcode = GetBarcode(section.PrintRequest.Request.AccountNoFull, 15, System.Drawing.RotateFlipType.RotateNoneFlipNone);
            e.Graphics.DrawImage(barcode, x + GetDPI(1.2f), y + GetDPI(5f));
            ...
            e.Graphics.DrawString("Regu. Busi.Hrs.: 10:45 AM To 03:30 PM", font6, brush, x + GetDPI(0.5f), y + GetDPI(8.9f));
            ...
            e.Graphics.DrawString("Web Address: www.umrethurban.com", font6, brush, x + GetDPI(0.5f), y + GetDPI(10.1f));
            ...
            e.Graphics.DrawString($"Contact No:{section.PrintRequest.Request.telo}", font7, brush, x + GetDPI(12.4f), y + GetDPI(8.8f));
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            if (!string.IsNullOrEmpty(section.PrintRequest.Request.additional_f1))
                e.Graphics.DrawString(section.PrintRequest.Request.additional_f1.Trim().ToUpper(), font9Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.accountNoX + 10.5f), y + GetDPI(BatchInPrinting.ChequeLayout.accountNoY));
