namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "153", Name = "Shree Savli Nagrik Sahakari Bank Ltd.", AddressLine1 = "Savli - 391 770, Dist . Vadodara ( Gujarat ) ", City = "Savli", State = "Gujarat", Country = "India", PostalCode = "391770", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
