namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "813", Name = "The Pij People's Co - Operative bank Ltd.", AddressLine1 = "Ta. Nadiad", AddressLine2="Dist. Kheda", AddressLine3="At Post -", City = "Pij", State = "Gujarat", Country = "India", PostalCode = "387230", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
