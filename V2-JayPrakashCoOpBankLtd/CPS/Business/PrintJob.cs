...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static void PrintBlankRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            e.Graphics.DrawString("BRANCH INFORMATION", font8Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X +1.5f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y +1f));
            e.Graphics.DrawString("Regu. Busi. Hrs.: FRI TO TUE 10:00 AM TO 4:00 PM" + section.PrintRequest.Branch.Time1, font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X +0.5f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 1.5f));
            e.Graphics.DrawString("Half Day Busi. Hrs.: WEDNESDAY 10:30 AM TO 1:00 PM" + section.PrintRequest.Branch.Time1, font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X +0.5f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 1.9f));
            e.Graphics.DrawString("Holidays: THURSDAY" + section.PrintRequest.Branch.Time2, font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X +0.5f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 2.3f));
            e.Graphics.DrawString(string.Format("Branch Email : {0}", section.PrintRequest.Branch.Email), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X +0.5f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 2.7f));
            e.Graphics.DrawString(string.Format("Web Address : {0}", oBankMasterDTO.WebAddress), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X +0.5f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 3.1f));
            e.Graphics.DrawString(string.Format("Contact No. : {0}", section.PrintRequest.Branch.Telephone1), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X +0.5f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 3.5f));
            /* END Left Section */

            /* START Right Section */

            e.Graphics.DrawString("CHEQUE BOOK REQUEST (BANK COPY)", font8Bold, brush, x + GetDPI(13.8f), y + GetDPI(0.5f));
            e.Graphics.DrawString("THE MANAGER", font7Bold, brush, x + GetDPI(12f), y + GetDPI(1.25f));
           ...
           // e.Graphics.DrawString("Date: ____________________", font7Bold, brush, x + GetDPI(21f), y + GetDPI(1.3f));
            ...
            e.Graphics.DrawString("Please issue _________Cheque books containig_________Leaves", font6Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2X -6f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 0.5f));
            e.Graphics.DrawString("Characteristics:          Bearer        Order", font6Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2X -6f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 0.9f));
            ...
            e.Graphics.DrawString("Cheque Book :             Normal                    Payable At Par", font6Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2X-6f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 1.3f));
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo, string printChequeBookAuditText)
        {
            ...
            if (BatchInPrinting.ChequeLayout.ifscVisble)
                e.Graphics.DrawString(string.Format("IFSC: {0}", section.PrintRequest.Branch.IFSC), font7Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.ifscX), y + GetDPI(BatchInPrinting.ChequeLayout.ifscY));
