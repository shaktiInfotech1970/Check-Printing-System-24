namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "802", Name = "THE NADIAD PEOPLE'S CO-OPERATIVE BANK LTD.", AddressLine1 = "AddressLine1", City = "Nadiad", State = "Gujarat", Country = "India", PostalCode = "387001", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
