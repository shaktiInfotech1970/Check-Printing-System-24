namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "809", Name = "The Mehmadabad Urban Co - Op. Bank Ltd.", AddressLine1 = "Bank Road", City = "Mahemadabad", State = "Gujarat", Country = "India ", PostalCode = "387130", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
