...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static string GetBranchAddress2(BranchMasterDTO branch, string bankName)
        {
            var sb = new StringBuilder();
            if (!string.IsNullOrWhiteSpace(bankName))
                sb.Append(bankName);
        ...
        {
            //var lastDate = new DateTime(2021, 9, 23);
        ...
        private static void PrintBlankRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            e.Graphics.DrawString("Half Dat Busi. Hrs.: " + section.PrintRequest.Branch.Time2, font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 1.8f));
            ...
            e.Graphics.DrawString(string.Format("Web Address : {0}", oBankMasterDTO.WebAddress), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 2.6f));
            e.Graphics.DrawString(string.Format("Contact No. : {0}", section.PrintRequest.Branch.Telephone1), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 3f));
            e.Graphics.DrawString(string.Format("Branch Service : {0}", "ATM, LOCKER"), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 3.4f));
            /* END Left Section */
            ...
            if (BatchInPrinting.RequestLayout.branchAddress2Visble)
                e.Graphics.DrawString(GetBranchAddress2(section.PrintRequest.Branch, oBankMasterDTO?.Name), font7Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.branchAddress2Y));
            //GetDPI(12.3f), GetDPI(1.8f)

            e.Graphics.DrawString("Date: _____/_____/________", font7Bold, brush, x + GetDPI(21f), y + GetDPI(1.3f));
            ...
            e.Graphics.DrawString("Please issue _________Cheque Book Containig_________Leaves.", font7Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 0.5f));
            ...
            e.Graphics.DrawString(string.Format("Tel No: {0}", section.PrintRequest.Request.telr), font7, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 2.25f));
            e.Graphics.DrawString(string.Format("Mobile No: {0}", section.PrintRequest.Request.mob), font7, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 2.75f));
            e.Graphics.DrawString("Signature Verified / Authorized", font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X + 9.9f), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 1.0f));
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo, string printChequeBookAuditText)
        {
            ...
            if (BatchInPrinting.ChequeLayout.ifscVisble)
                e.Graphics.DrawString(string.Format("IFS Code: {0}", section.PrintRequest.Branch.IFSC), IFSCFont, brush, x + GetDPI(BatchInPrinting.ChequeLayout.ifscX), y + GetDPI(BatchInPrinting.ChequeLayout.ifscY));
            ...
            {
                e.Graphics.DrawString(BatchInPrinting.ChequeLayout.custom1Text, font7, brush, x + GetDPI(BatchInPrinting.ChequeLayout.custom1X), y + GetDPI(BatchInPrinting.ChequeLayout.custom1Y));
            }
