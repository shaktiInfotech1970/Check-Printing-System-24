    ...
    public class PrintJob
    {
        ...
        private static string GetBranchAddress(BranchMasterDTO branch)
        {
            ...
            if (!string.IsNullOrWhiteSpace(branch.City))
                sb.Append(string.Format(" : {0}", branch.PostalCode));
        ...
        {
            var lastDate = new DateTime(2030, 9, 20);
        ...
        private static void PrintBlankRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            e.Graphics.DrawString("Sunday Working : " + "No", font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X - 0.6f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 2.2f));
            ...
            e.Graphics.DrawString(string.Format("Branch Service: LOCKER"), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X - 0.6f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 4.6f));
            /* END Left Section */
