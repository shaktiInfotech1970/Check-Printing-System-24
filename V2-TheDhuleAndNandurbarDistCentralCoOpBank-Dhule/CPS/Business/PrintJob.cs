...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        {
            var lastDate = new DateTime(2022, 9, 23);
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo, string printChequeBookAuditText)
        {
            ...
            if (BatchInPrinting.ChequeLayout.custom1Visible)
                e.Graphics.DrawString(string.Format("{0}", BatchInPrinting.ChequeLayout.custom1Text), font7Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.custom1X), y + GetDPI(BatchInPrinting.ChequeLayout.custom1Y));
