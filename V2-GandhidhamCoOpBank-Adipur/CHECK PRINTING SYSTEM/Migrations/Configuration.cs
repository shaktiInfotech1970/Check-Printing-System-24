namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "802", Name = "Gandhidham Co - Op Bank", AddressLine1 = "Plot No. 303", City = "Gandhidham", State = "Gujarat", Country = "India", PostalCode = "370201", WebAddress = "gandhidham.br@gcbl.in", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
