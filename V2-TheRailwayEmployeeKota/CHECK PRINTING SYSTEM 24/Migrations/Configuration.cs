namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "211", Name = "THE RAILWAY EMPLOYEE'S CO - OP. BANK LTD.", AddressLine1 = "POWER HOUSE ROAD, NR. JAIPUR METALS", City = "JAIPUR", State = "RAJASTHAN", Country = "INDIA", PostalCode = "302006", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
