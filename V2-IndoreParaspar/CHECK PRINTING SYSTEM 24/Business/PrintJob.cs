...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static string GetBranchAddress1(BranchMasterDTO branch)
        {
            ...
            if (!string.IsNullOrWhiteSpace(branch.Name))
                sb.Append("INDORE PARASPAR SAHAKARI BANK LTD., INDORE");
        ...
        private static void PrintRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            e.Graphics.DrawString(string.Format("Present Cheque no. From: {0} To {1}", section.PrintRequest.Request.ChequeFrom.ToString("00000"), section.PrintRequest.Request.ChequeTo.ToString("00000")), font8, brush, x + GetDPI(0.5f), y + GetDPI(7.5f));

                    e.Graphics.DrawString("BRANCH INFORMATION", font8, brush, x + GetDPI(1.5f), y + GetDPI(8.3f));
            switch (Convert.ToInt32(section.PrintRequest.Branch.Code))
            {
                case 2:
                    e.Graphics.DrawString("Regu. Busi.Hrs.: 9:00 am to 2.45 pm & 3.30 pm to 8:00 pm", font6, brush, x + GetDPI(0.5f), y + GetDPI(8.9f));
                    break;
                case 3:
                    e.Graphics.DrawString("Regu. Busi.Hrs.: 11:00 am to 5:15 pm", font6, brush, x + GetDPI(0.5f), y + GetDPI(8.9f));
                    break;
                case 4:
                    e.Graphics.DrawString("Regu. Busi.Hrs.: 9:00 am to 3:15 pm", font6, brush, x + GetDPI(0.5f), y + GetDPI(8.9f));
                    break;
                case 5:
                    e.Graphics.DrawString("Regu. Busi.Hrs.: 11:00 am to 5:15 pm", font6, brush, x + GetDPI(0.5f), y + GetDPI(8.9f));
                    break;
                case 6:
                    e.Graphics.DrawString("Regu. Busi.Hrs.: 10:30 am to 4.45 pm", font6, brush, x + GetDPI(0.5f), y + GetDPI(8.9f));
                    break;
            }

            e.Graphics.DrawString("Holiday: 2nd 4th SATURDAY", font6, brush, x + GetDPI(0.5f), y + GetDPI(9.3f));
            e.Graphics.DrawString("Weekly Holiday: SUNDAY", font6, brush, x + GetDPI(0.5f), y + GetDPI(9.7f));
            e.Graphics.DrawString(string.Format("Bank Email:  {0}", "ipsb.main@indoreparaspar.com"), font6, brush, x + GetDPI(0.5f), y + GetDPI(10.1f));
            e.Graphics.DrawString(string.Format("Branch Email:  {0}", section.PrintRequest.Branch.Email), font6, brush, x + GetDPI(0.5f), y + GetDPI(10.5f));
            e.Graphics.DrawString(string.Format("Contact No:     {0}", section.PrintRequest.Branch.Telephone1), font6, brush, x + GetDPI(0.5f), y + GetDPI(10.9f));
            //e.Graphics.DrawString(string.Format("                {0}", section.PrintRequest.Branch.Telephone2), font6, brush, x + GetDPI(0.5f), y + GetDPI(11.7f));
            /* END Left Section */
            ...
            e.Graphics.DrawString("by Register Post/per bearer", font7Bold, brush, x + GetDPI(12.4f), y + GetDPI(4.5f));
            ...
            e.Graphics.DrawString(string.Format("Present Cheque no. From: {0} To {1}", section.PrintRequest.Request.ChequeFrom.ToString("00000"), section.PrintRequest.Request.ChequeTo.ToString("00000")), font7Bold, brush, x + GetDPI(12.4f), y + GetDPI(5.2f));
            e.Graphics.DrawString(string.Format("{0}: {1}", section.PrintRequest.AccountType.Name, section.PrintRequest.Request.AccountNoFull), font9Bold, brush, x + GetDPI(12.4f), y + GetDPI(6f));
