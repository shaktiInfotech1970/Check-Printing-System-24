...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static string GetBranchAddress1(BranchMasterDTO branch, string bankName)
        {
            ...
            if (!string.IsNullOrWhiteSpace(branch.City))
                sb.Append(string.Format("{0}{1} - {2}   RTGS/NEFT IFSC CODE: {3}", "," + System.Environment.NewLine, branch.IFSC.ToUpper()));
        ...
        private static void PrintBlankRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
           ...
           // e.Graphics.DrawString("BRANCH INFORMATION", font8Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X + 1f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 0.8f));
            ...
            e.Graphics.DrawString("CHEQUE BOOK REQUEST (BANK COPY)", font8Bold, brush, x + GetDPI(16f), y + GetDPI(0.5f));
            e.Graphics.DrawString("THE MANAGER", font7Bold, brush, x + GetDPI(12.3f), y + GetDPI(0.9f));
            ...
            e.Graphics.DrawString("Signature Verified / Authorized", font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X + 8.5f), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 1.8f));
            e.Graphics.DrawString("Signature of Bearer", font6Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 3.5f));
            e.Graphics.DrawString("Received By", font7Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X +8.5f), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 3.8f));
