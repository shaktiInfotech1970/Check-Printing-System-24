namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "808", Name = "The Malegaon Merchants Co Op Bank Ltd", AddressLine1 = "379, Mamco Bhavan, Somvar Ward", City = "Malegaon", State = "Maharashtra", Country = "India", PostalCode = "423203", WebAddress = "", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
