...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static string GetBranchAddress(BranchMasterDTO branch)
        {
            ...
            sb.Append(string.Format(" IFSC - {0}", branch.IFSC.ToUpper()));

            return sb.ToString();
        }
        private static string GetBranchAddress1(BranchMasterDTO branch, string bankName, bool IsIFSCRequired = false)
        {
            var sb = new StringBuilder();
            ...
            if (!string.IsNullOrWhiteSpace(branch.AddressLine3))
                sb.Append(", " + System.Environment.NewLine + branch.AddressLine3);
            if (!string.IsNullOrWhiteSpace(branch.City))
                sb.Append(string.Format("{0}{1} - {2}", "," + System.Environment.NewLine, branch.City, branch.PostalCode));
            if (IsIFSCRequired)
                sb.Append(string.Format("   IFS CODE: {0}", branch.IFSC.ToUpper()));
        ...
        private static string GetStamp(RequestDTO request)
        {
            ...
            {
                sb.Append(new string(' ', 5) + request.Signatory2);
            }
            if (!string.IsNullOrWhiteSpace(request.Signatory3))
            {
                sb.Append(new string(' ', 5) + request.Signatory3);
            }
        ...
        private static void PrintBlankRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            /* START Left Section */
            if (BatchInPrinting.RequestLayout.branchAddress1Visble)
                e.Graphics.DrawString(GetBranchAddress1(section.PrintRequest.Branch, oBankMasterDTO?.Name, true), font6Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress1X), y + GetDPI(BatchInPrinting.RequestLayout.branchAddress1Y));
            ...
            //e.Graphics.DrawString(string.Format("{0}", section.PrintRequest.Branch.ShortName), font7, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo1X +1f), y + GetDPI(BatchInPrinting.RequestLayout.accountNo1X + 5f));
            if (BatchInPrinting.RequestLayout.chequeFrom1Visble)
            ...
            e.Graphics.DrawString("BRANCH INFORMATION", font8Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo1X + 1f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 0.8f));
            e.Graphics.DrawString("Regu. Busi. Hrs.: " + section.PrintRequest.Branch.Time1, font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 1.4f));
            e.Graphics.DrawString("Weekly Holidays: " + section.PrintRequest.Branch.Time2, font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 1.8f));
            e.Graphics.DrawString(string.Format("Branch Email - 1: {0}", section.PrintRequest.Branch.Email), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 2.2f));
            e.Graphics.DrawString(string.Format("Branch Email - 2: {0}", section.PrintRequest.Branch.Email2), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 2.6f));
            e.Graphics.DrawString(string.Format("Web Address : {0}", oBankMasterDTO.WebAddress), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 3f));
            e.Graphics.DrawString(string.Format("Contact No. : {0}", section.PrintRequest.Branch.Telephone1), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 3.4f));
            /* END Left Section */

            /* START Right Section */

            e.Graphics.DrawString("CHEQUE BOOK REQUEST (BANK COPY)", font8Bold, brush, x + GetDPI(13.8f), y + GetDPI(0.5f));
            e.Graphics.DrawString("THE MANAGER", font7Bold, brush, x + GetDPI(12.5f), y + GetDPI(1.3f));
            ...
            e.Graphics.DrawString("Please issue _________Cheque books containig_________Leaves", font7Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 0.5f));
            e.Graphics.DrawString("Characteristics:          Bearer        Order", font7Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 1.2f));
            Pen blackPen = new Pen(Color.FromArgb(255, 0, 0, 0), 1);
            e.Graphics.DrawRectangle(blackPen, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress2X + 5.7f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 1.15f), 15, 15);
            e.Graphics.DrawRectangle(blackPen, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress2X + 7.7f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 1.15f), 15, 15);
            e.Graphics.DrawString("Cheque Book :             Normal                    Payable At Par", font7Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 1.9f));
            e.Graphics.DrawRectangle(blackPen, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress2X + 5.95f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 1.85f), 15, 15);
            e.Graphics.DrawRectangle(blackPen, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress2X + 11.1f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 1.85f), 15, 15);
            ...
            e.Graphics.DrawString(string.Format("{0}", section.PrintRequest.Branch.ShortName), font7, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 2.5f));
            e.Graphics.DrawString(string.Format("Contact No.: {0}", section.PrintRequest.Request.mob), font7, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 3f));
            e.Graphics.DrawString("Signature Verified / Authorized", font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X + 9.9f), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 2.2f));
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo, string printChequeBookAuditText)
        {
            ...
            if (BatchInPrinting.ChequeLayout.stampVisble)
            {
                ...
                if (section.PrintRequest.Request.Name.ToUpper() == "LOOSE")
                {
                    stampRect = new RectangleF(x + GetDPI(0.5F), y + GetDPI(6.5f), 750, 90);
