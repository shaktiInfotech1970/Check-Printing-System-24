namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "001", Name = "THE DHOLPUR URBAN CO-OPERATIVE BANK LTD", AddressLine1 = "Hanuman Tiraha",AddressLine2= "Lal Bazar", City = "DHOLPUR", State = "Rajasthan", Country = "India", PostalCode = "328001",
                Phone="05642223022", Mobile= "9024228990", Email= "urbanbankdholpur@gmail.com" ,
 CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
        ...
        private void SeedPermission(CPSDbContext context)
        {
            context.Permission.AddOrUpdate(new PermissionDTO { Id = 1, UserId = 1, Page = Common.Page.AccountType, Permission = 7, CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now },
                                           ...
                                           new PermissionDTO { Id = 53, UserId = 1, Page = Common.Page.RemoveRequestData, Permission = 7, CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
        }
