...
namespace CPS.Business
{
    ...
    public class RequestBase : BaseEntity
    {
        ...
        [ParseBasedOnLength(502, 3)]
        public int CityCode { get; set; }

        [Display(Name = "Bank Code", Order = 3)]
        [ParseBasedOnLength(505, 3)]
        public int BankCode { get; set; }

        [Display(Name = "Branch Code", Order = 4)]
        [Required]
        [ParseBasedOnLength(508, 3)]
        ...
        {
            get { return string.Format("{0}{1}{2}", CityCode.ToString("000"), BankCode.ToString("000"), BranchCode.ToString("000")); }
        }

        [Display(Name = "A/C No", Order = 5)]
        [Required]
        [ParseBasedOnLength(208, 6)]
        public string AccountNo { get; set; }

        [Display(Name = "A/C BH", Order = 6)]
        [Required]
        [ParseBasedOnLength(197, 17)]
        public string AccountNoFull { get; set; }

        [Display(Name = "Trx Code", Order = 7)]
        [Required]
        [ParseBasedOnLength(511, 2)]
        public int TransactionCode { get; set; }

        [Display(Name = "Name", Order = 8)]
        [Required]
        [ParseBasedOnLength(214, 30)]
        public string Name { get; set; }

        [Display(Name = "Joint Name 1", Order = 9)]
        [ParseBasedOnLength(244, 30)]
        public string JointName1 { get; set; }

        // [Display(Name = "Joint Name 2", Order = 10)]
        public string JointName2 { get; set; }

        [Display(Name = "Signatory 1", Order = 11)]
        public string Signatory1 { get; set; }

        [Display(Name = "Signatory 2", Order = 12)]
        public string Signatory2 { get; set; }

        // [Display(Name = "Signatory 3", Order = 13)]
        public string Signatory3 { get; set; }

        [Display(Name = "Address 1", Order = 14)]
        [ParseBasedOnLength(274, 40)]
        public string Address1 { get; set; }

        [Display(Name = "Address 2", Order = 15)]
        [ParseBasedOnLength(314, 40)]
        public string Address2 { get; set; }

        [Display(Name = "Address 3", Order = 16)]
        [ParseBasedOnLength(354, 40)]
        public string Address3 { get; set; }

        [Display(Name = "Address 4", Order = 17)]
        [ParseBasedOnLength(394, 40)]
        public string Address4 { get; set; }

        // [Display(Name = "Address 5", Order = 18)]
        public string Address5 { get; set; }

        [Display(Name = "City", Order = 19)]
        [ParseBasedOnLength(434, 30)]
        public string City { get; set; }

        [Display(Name = "PinCode", Order = 20)]
        [ParseBasedOnLength(464, 8)]
        public string PostalCode { get; set; }

        // [Display(Name = "telr", Order = 21)]
        public string telr { get; set; }

        //  [Display(Name = "telo", Order = 22)]
        public string telo { get; set; }

        // [Display(Name = "mob", Order = 23)]
        public string mob { get; set; }

        [Display(Name = "No of ChqBook", Order = 24)]
        [Required]
        [ParseBasedOnLength(538, 3)]
        public int NoOfChequeBook { get; set; }

        [Required]
        [Display(Name = "No of Cheque", Order = 25)]
        [ParseBasedOnLength(535, 3)]
        public int NoOfCheque { get; set; }

        //  [Display(Name = "Bearer Order", Order = 26)]
        [Required]
        public string BearerOrder { get; set; }

        [Required]
        // [Display(Name = "AtPar", Order = 27)]
        [MaxLength(1)]
        public string AtPar { get; set; }

        // [Display(Name = "prcode", Order = 28)]
        public string prcode { get; set; }

        [Required]
        [Display(Name = "Cheque From", Order = 29)]
        [ParseBasedOnLength(523, 6)]
        public int ChequeFrom { get; set; }

        [Required]
        [Display(Name = "Cheque To", Order = 30)]
        [ParseBasedOnLength(529, 6)]
    ...
    public class ImportRequest
    {
        ...
        private bool Parse(string line, RequestDTO importData)
        {
            ...
            var properties = importData.GetType().GetProperties()
                .Where(w => w.GetCustomAttributes(typeof(ParseBasedOnLengthAttribute), false).Count() > 0);
            foreach (var property in properties)
            {
                var parseAttribute = (property.GetCustomAttributes(typeof(ParseBasedOnLengthAttribute), false)[0] as ParseBasedOnLengthAttribute);
                var start = parseAttribute.Start - 1;
                property.SetValue(importData, Convert.ChangeType(line.Substring(start, parseAttribute.End).Trim().Trim(new char[] { '"' }), property.PropertyType), null);
            }
