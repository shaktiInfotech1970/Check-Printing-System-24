namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "513", Name = "RAJLAXMI URBAN CO-OP. BANK LTD.", AddressLine1 = "NASIK", City = "NASIK", State = "MAHARASHRTA", Country = "India", PostalCode = "422003", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
