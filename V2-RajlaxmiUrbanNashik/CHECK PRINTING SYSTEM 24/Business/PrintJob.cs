...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static string GetBranchAddress1(BranchMasterDTO branch)
        {
            ...
            string bankName = BranchMasterDTO.GetBankInfo(branch.MICR.Substring(3, 3))?.Name;
        ...
        {
            if (print.Request.BearerOrder.ToLower() == "order")
            {
                return string.Format("C{0}C {1}A        {2}", (print.Request.ChequeFrom + (currentChequeNo - 1)).ToString("000000"), print.Branch.MICR, print.Request.TransactionCode);
            }
            else
            {
        ...
        {
            var lastDate = new DateTime(2022, 5, 5);
        ...
        private static void PrintRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            /* START Left Section */
            e.Graphics.DrawString(GetBranchAddress1(section.PrintRequest.Branch), font6Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.branchAddress1X), y + GetDPI(BatchInPrinting.RequestLayout.branchAddress1Y));
            e.Graphics.DrawString(section.PrintRequest.Branch.ShortName, font6Bold, brush, x + GetDPI(8f), y + GetDPI(1.8f)); //Newly Added Branch Shot Name
            ...
            e.Graphics.DrawString("Web Address: www.rajlaxmibank.com", font6, brush, x + GetDPI(0.5f), y + GetDPI(10.5f));
            /* END Left Section */
            ...
            e.Graphics.DrawString(string.Format("Cheque no. From: {0} To {1}", section.PrintRequest.Request.ChequeFrom.ToString("000000"), section.PrintRequest.Request.ChequeTo.ToString("000000")), font7Bold, brush, x + GetDPI(12.4f), y + GetDPI(3.6f));

            e.Graphics.DrawString("Please issue _________Cheque books containig_________Leaves", font7Bold, brush, x + GetDPI(12.4f), y + GetDPI(4.1f));
            e.Graphics.DrawString("Characteristics:          Bearer        Order", font7Bold, brush, x + GetDPI(12.4f), y + GetDPI(4.8f));
            Pen blackPen = new Pen(Color.FromArgb(255, 0, 0, 0), 1);
            e.Graphics.DrawRectangle(blackPen, x + GetDPI(18.1f), y + GetDPI(4.75f), 15, 15);
            e.Graphics.DrawRectangle(blackPen, x + GetDPI(20.1f), y + GetDPI(4.75f), 15, 15);
            ...
            e.Graphics.DrawString("Cheque Book :             Normal                    Payable At Par", font7Bold, brush, x + GetDPI(12.4f), y + GetDPI(5.5f));
            e.Graphics.DrawRectangle(blackPen, x + GetDPI(18.35f), y + GetDPI(5.45f), 15, 15);
            e.Graphics.DrawRectangle(blackPen, x + GetDPI(23.5f), y + GetDPI(5.45f), 15, 15);
            e.Graphics.DrawString(string.Format("{0}: {1}", section.PrintRequest.AccountType.Name, section.PrintRequest.Request.AccountNoFull), font8Bold, brush, x + GetDPI(12.4f), y + GetDPI(6.1f));
            PrintNameAddress(e, section.PrintRequest.Request, x + GetDPI(12.4f), y + GetDPI(6.6f));
            e.Graphics.DrawString(string.Format("Tel No: {0}", section.PrintRequest.Request.telr), font7, brush, x + GetDPI(12.4f), y + GetDPI(9.1f));
            e.Graphics.DrawString(string.Format("Mobile No: {0}", section.PrintRequest.Request.mob), font7, brush, x + GetDPI(12.4f), y + GetDPI(9.6f));
            e.Graphics.DrawString("Signature Verified / Authorized", font6, brush, x + GetDPI(22.3f), y + GetDPI(8.4f));
            e.Graphics.DrawString("Signature of Bearer", font6Bold, brush, x + GetDPI(12.4f), y + GetDPI(11.1f));

            RectangleF stampRect = new RectangleF(x + GetDPI(11.2f), y + GetDPI(7.5f), 450, 110);
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            if (section.PrintRequest.Request.BearerOrder.ToLower() == "order")
                e.Graphics.DrawString(section.PrintRequest.Branch.ShortName, IFSCFont, brush, x + GetDPI(BatchInPrinting.ChequeLayout.accountNoX) + GetDPI(2.0f), y + GetDPI(BatchInPrinting.ChequeLayout.ifscY));

            if (section.PrintRequest.Request.BearerOrder.ToLower() == "order")
                e.Graphics.DrawString("PAY ORDER", font9Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.ifscX) + GetDPI(5.0f), y + GetDPI(BatchInPrinting.ChequeLayout.ifscY) + GetDPI(0.05f));
            ...
            {
                if (section.PrintRequest.Request.BearerOrder.ToLower() == "bearer")
                    ...
                    e.Graphics.DrawString("On Account of", font9Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.accountNoX), y + GetDPI(BatchInPrinting.ChequeLayout.accountNoY));
            }

            if (section.PrintRequest.Request.BearerOrder.ToLower() == "order")
                e.Graphics.DrawString("Not Over  ________________", font8, brush, x + GetDPI(BatchInPrinting.ChequeLayout.accountNoX) + GetDPI(7.0f), y + GetDPI(BatchInPrinting.ChequeLayout.accountNoY) + GetDPI(2.7f));
            ...
            if (section.PrintRequest.Request.BearerOrder.ToLower() == "order")
            {
                imgBarcode = GetBarcode(string.Format("{0}{1}{2}", (section.PrintRequest.Request.ChequeFrom + (section.SequenceNo - 1)).ToString("000000"), section.PrintRequest.Request.MICRCode, section.PrintRequest.Request.TransactionCode), 12, System.Drawing.RotateFlipType.Rotate270FlipNone);
            }
            else
            {
                imgBarcode = GetBarcode(string.Format("{0}{1}{2}{3}", (section.PrintRequest.Request.ChequeFrom + (section.SequenceNo - 1)).ToString("000000"), section.PrintRequest.Request.MICRCode, Convert.ToInt32(section.PrintRequest.Request.AccountNo).ToString("000000"), section.PrintRequest.Request.TransactionCode), 12, System.Drawing.RotateFlipType.Rotate270FlipNone);
            }


            if (BatchInPrinting.ChequeLayout.barcodeVisble && section.PrintRequest.Request.BearerOrder.ToLower() == "bearer")
