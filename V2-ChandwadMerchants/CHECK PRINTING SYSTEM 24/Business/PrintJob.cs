...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static string GetBranchAddress1(BranchMasterDTO branch)
        {
            ...
            if (!string.IsNullOrWhiteSpace(branch.Name))
                sb.Append("THE CHANDWAD MERCHANTS CO-OP BANK LTD.");
        ...
        private static void PrintRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            e.Graphics.DrawString(string.Format("Cheque no. From: {0} To {1}", section.PrintRequest.Request.ChequeFrom.ToString("00000"), section.PrintRequest.Request.ChequeTo.ToString("00000")), font7Bold, brush, x + GetDPI(12.4f), y + GetDPI(3.3f));
