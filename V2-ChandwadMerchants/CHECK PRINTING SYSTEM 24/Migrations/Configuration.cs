namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "899", Name = "CHANDWAD MERCHANTS CO-OP BANK LTD.", AddressLine1 = "CHANDWAD", City = "CHANDWAD", State = "MAHARASHTRA", Country = "India", PostalCode = "423101", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
