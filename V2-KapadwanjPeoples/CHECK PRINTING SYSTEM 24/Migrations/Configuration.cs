namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "806", Name = "THE KAPADWANJ PEOPLES CO OP BANK LTD", AddressLine1 = "GANDHICHOWK, DANIWADA, KAPADWANJ, DIST:KHEDA", City = "KAPADWANJ", State = "GUJARAT", Country = "INDIA", PostalCode = "387620", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
