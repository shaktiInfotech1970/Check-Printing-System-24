namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "810", Name = "KODINAR NAGRIK SAHAKARI BANK LTD", AddressLine1 = "BANKADDRESS", City = "KODINAR", State = "GUJARAT", Country = "INDIA", PostalCode = "362720", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
