...
namespace CPS.Business
{
    ...
    public class RequestBase : BaseEntity
    {
        ...
        [NotMapped]
        public string AccountNoFullPrint { get { return string.Format("{0}{1}{2}", BankCode.ToString("000"), BranchCode.ToString("000"), AccountNoFull); } }

        [NotMapped]
        public string AccountNoFullPrintPayOrder { get { return string.Format("GL{0}", AccountNoFull); } }
