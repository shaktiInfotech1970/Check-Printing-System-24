    ...
    public partial class DaywiseChequePrint : UserControl
    {
        ...
        private void btnShowColumns_Click(object sender, RoutedEventArgs e)
        {
            using (var context = new CPSDbContext())
            {
                ...
                var response = query.OrderBy(o => o.Branch.Name).OrderBy(o => o.Request.TransactionCode).OrderBy(o => o.Request.ChequeFrom).ToList();
                int counter = 0;
        ...
        private void btnPrint_Click(object sender, RoutedEventArgs e)
        {
            ...
            ReportPDF report = new ReportPDF(dgDaywiseChequePrint, new float[] { 25, 90, 250, 150, 40, 90, 90, 60 });
