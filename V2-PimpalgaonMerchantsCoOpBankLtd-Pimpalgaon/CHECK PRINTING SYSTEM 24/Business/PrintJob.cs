...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        {
            //var lastDate = new DateTime(2024, 8, 20);
        ...
        private static void PrintBlankRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            if (BatchInPrinting.RequestLayout.chequeFrom1Visble)
                e.Graphics.DrawString(string.Format("Cheque no. From: {0} To {1}", section.PrintRequest.Request.ChequeFrom.ToString("000000"), section.PrintRequest.Request.ChequeTo.ToString("000000")), font8, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y));
            //GetDPI(0.5f), GetDPI(7.5f)

            e.Graphics.DrawString("BRANCH INFORMATION", font8, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X + 1f), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 0.8f));
            e.Graphics.DrawString("Regu. Busi. Hour : " + section.PrintRequest.Branch.Time1, font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 1.4f));
            e.Graphics.DrawString("Half  Day Busi. Hour : " + section.PrintRequest.Branch.Time2, font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 1.8f));
            e.Graphics.DrawString("Weekly Holiday : " + "NO", font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 2.2f));
            e.Graphics.DrawString(string.Format("Branch Email : {0}", section.PrintRequest.Branch.Email), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 2.6f));
            ...
            e.Graphics.DrawString(string.Format("Contact No : {0}", section.PrintRequest.Branch.Telephone1), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 3.4f));
            e.Graphics.DrawString("Toll Free No. : " + "", font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 3.8f));
            e.Graphics.DrawString(string.Format("Branch Service : {0}", "LOCKER"), font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom1Y + 4.2f));
            ...
            e.Graphics.DrawString("CHEQUE BOOK REQUEST (BANK COPY)", font8, brush, x + GetDPI(13.8f), y + GetDPI(0.5f));
            ...
            e.Graphics.DrawString("Date: ____________________", font7, brush, x + GetDPI(21f), y + GetDPI(1.3f));

            if (BatchInPrinting.RequestLayout.chequeFrom2Visble)
                e.Graphics.DrawString(string.Format("Cheque no. From: {0} To {1}", section.PrintRequest.Request.ChequeFrom.ToString("000000"), section.PrintRequest.Request.ChequeTo.ToString("000000")), font8, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y));
            //GetDPI(12.3f), GetDPI(3.6f)

            e.Graphics.DrawString("Please issue _________Cheque books containig_________Leaves", font7, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 0.5f));
            e.Graphics.DrawString("Characteristics:          Bearer             Order", font7, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 1.2f));
            ...
            e.Graphics.DrawString("Cheque Book :             Normal                    Payable At Par", font7, brush, x + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2X), y + GetDPI(BatchInPrinting.RequestLayout.chequeFrom2Y + 1.9f));
            ...
            e.Graphics.DrawString(string.Format("Contact No.: {0}", section.PrintRequest.Request.telr), font7, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 2.4f));

            e.Graphics.DrawString("Signature Verified / Authorized", font6, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X + 9.9f), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 1.4f));
            e.Graphics.DrawString("Signature of Bearer", font6Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 4.1f));

            RectangleF stampRect = new RectangleF(x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X - 1.2f), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y + 0.5f), 450, 110);
