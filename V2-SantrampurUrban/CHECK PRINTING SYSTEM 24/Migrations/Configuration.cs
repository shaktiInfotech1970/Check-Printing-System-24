namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "501", Name = "THE SANTRAMPUR URBAN CO OP BANK LTD", AddressLine1 = "BANK ADDRESS", City = "VADODARA", State = "GUJARAT", Country = "India", PostalCode = "390005", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
