namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "819", Name = "THE SARSA PEOPLE'S CO - OP. BANK LTD.", AddressLine1 = "Bazar, P.O. Sarsa", City = "Sarsa", State = "Gujarat", Country = "India", PostalCode = "388365", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
