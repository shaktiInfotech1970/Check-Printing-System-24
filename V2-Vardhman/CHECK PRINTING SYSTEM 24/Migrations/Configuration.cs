namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            //context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "153", Name = "BANKNAME", AddressLine1 = "BANKADDRESS", City = "CITY", State = "STATE", Country = "India", PostalCode = "000000", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
