...
namespace CPS.Business
{
    ...
    public class RequestBase : BaseEntity
    {
        ...
        [NotMapped]
        public string MICRCode { get { return string.Format("{0:000}{1:000}{2:000}", CityCode, "532", BranchCode); } }
        //public string MICRCode { get { return string.Format("{0:000}{1:000}{2:000}", CityCode, BankCode, BranchCode); } }

        [Display(Name = "BankBranch", Order = 5)]
        ...
        [Display(Name = "PostalCode", Order = 19)]
        ...
        [Display(Name = "additional_f1", Order = 26)]
        public string additional_f1 { get; set; }

        [Display(Name = "additional_f2", Order = 27)]
