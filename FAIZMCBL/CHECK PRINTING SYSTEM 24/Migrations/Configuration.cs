namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "810", Name = "THE FAIZ MERCANTILE  CO-OP BANK LTD.", AddressLine1 = "SARDA CIRCLE BRANCH : SURVEY NO.532, RAJIV BHAVAN,NASHIK,PUNE ROAD", City = "NASHIK", State = "Maharashtra", Country = "India", PostalCode = "422001", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
