...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static string GetMICR(PrintRequest print, int currentChequeNo)
        {
            return string.Format("C{0}C {1}A {2} {3}", (print.Request.ChequeFrom + (currentChequeNo - 1)).ToString("000000"), print.Branch.MICR, string.Empty.PadLeft(7, (char)32), print.Request.TransactionCode);
        }        
