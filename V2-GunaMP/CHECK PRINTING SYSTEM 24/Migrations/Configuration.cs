namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "815", Name = "GUNA NAGRIK SAHAKARI BANK MARYADIT, GUNA", AddressLine1 = "Head Office : Hospital Road, Opp. Gurudwara, A. B. Road", City = "GUNA", State = "MADHYA PRADESH", Country = "India", PostalCode = "473001", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
