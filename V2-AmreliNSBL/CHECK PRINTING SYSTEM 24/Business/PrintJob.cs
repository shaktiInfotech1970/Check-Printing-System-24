...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        private static string GetBranchAddress1(BranchMasterDTO branch)
        {
            ...
            if (!string.IsNullOrWhiteSpace(branch.Name))
                sb.Append("Amreli Nagarik Sahakari Bank Ltd.");
        ...
        private static void PrintRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            e.Graphics.DrawString(string.Format("{0}: {1}", section.PrintRequest.AccountType.Name, section.PrintRequest.Request.AccountNoFull), font7Bold, brush, x + GetDPI(1.4f), y + GetDPI(1.9f));
            ...
            e.Graphics.DrawString("Regu. Busi.Hrs.: 10:30 AM To 02:00 PM & 02:30 PM To 04:30 PM", font6, brush, x + GetDPI(0.5f), y + GetDPI(8.9f));
            e.Graphics.DrawString("Holidays: 2nd & 4th Saturday & All Sunday", font6, brush, x + GetDPI(0.5f), y + GetDPI(9.3f));
            ...
            e.Graphics.DrawString("Web Address: www.amrelibank.com", font6, brush, x + GetDPI(0.5f), y + GetDPI(10.5f));
            /* END Left Section */
            ...
            e.Graphics.DrawString("Date : ____________________", font7Bold, brush, x + GetDPI(21f), y + GetDPI(1.8f));
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            Font IFSCFont = new Font("Consolas", 7, FontStyle.Bold);
            ...
            if (BatchInPrinting.ChequeLayout.branchAddressVisble)
                e.Graphics.DrawString(GetBranchAddress(section.PrintRequest.Branch), font6Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.branchAddressX), y + GetDPI(BatchInPrinting.ChequeLayout.branchAddressY));
            ...
            {
                e.Graphics.DrawString("Not Over Rs.:_______________________", font9Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.accountNoX + 6f), y + GetDPI(BatchInPrinting.ChequeLayout.accountNoY + 2f));
                e.Graphics.DrawString("on account of__________________________________", font9Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.accountNoX), y + GetDPI(BatchInPrinting.ChequeLayout.accountNoY + 3.2f));
            }
            else
            {
                e.Graphics.DrawString("Payable at Par at all CBS Branches", font9Bold, brush, x + GetDPI(BatchInPrinting.ChequeLayout.accountNoX + 6f), y + GetDPI(BatchInPrinting.ChequeLayout.accountNoY + 2f));
            }
