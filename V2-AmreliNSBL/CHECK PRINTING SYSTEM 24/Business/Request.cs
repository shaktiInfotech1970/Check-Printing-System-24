...
namespace CPS.Business
{
    ...
    public class RequestBase : BaseEntity
    {
        ...
        [Display(Name = "additional_f11", Order = 42)]
        [Parse(42)]
        public string additional_f11 { get; set; }

        [Display(Name = "additional_f12", Order = 43)]
        [Parse(43)]
        public string additional_f12 { get; set; }

        [Display(Name = "additional_f13", Order = 44)]
        [Parse(44)]
        public string additional_f13 { get; set; }
    }
        ...
        public override bool IsValid(IList<ValidationResult> results)
        {
            ...
            try
            {
                using (var context = new CPSDbContext())
                {
                    ...
                    List<int> bookSize = new List<int>() { 9, 15, 30, 45, 60 };
