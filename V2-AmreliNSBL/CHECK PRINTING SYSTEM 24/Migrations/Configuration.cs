namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "802", Name = "AMRELI NAGARIK SAHAKARI BANK LTD.", AddressLine1 = "MAIN BRANCH, MAGRIK BHAVAN", City = "AMRELI", State = "GUJARAT", Country = "India", PostalCode = "365601", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
