namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "812", Name = "Uttarsanda People's Co - Op. Bank Ltd.", AddressLine1 = "Ta. Nadiad", AddressLine2 = "Dist. Kheda", AddressLine3 = "At Post -", City = "Uttarsanda", State = "Gujarat", Country = "India", PostalCode = "387370", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
