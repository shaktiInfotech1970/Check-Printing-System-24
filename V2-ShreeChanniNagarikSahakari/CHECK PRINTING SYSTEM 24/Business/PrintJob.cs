...
namespace CPS.Business
{
    ...
    public class PrintJob
    {
        ...
        #region Value Helper
        private static string GetAccountTypShotName(AccountTypeDTO dto)
        {
        ...
        private static string GetStrippedAccountNo(RequestDTO request)
        {
            var accountNo = request.AccountNoFull;
            if (accountNo.Length >= 3)
            {
                var code = accountNo.Substring(0, 3);
                if (code == "315")
                {
                    accountNo = accountNo.Remove(0, 3);
                }
            }
            return accountNo;
        }
        ...
        private static void PrintNameAddress(PrintPageEventArgs e, RequestDTO request, float x, float y, float width, float height)
        {
            ...
            RectangleF stampRect = new RectangleF(x, y + GetDPI(0.6f), width, height);
        ...
        private static void PrintRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            if (BatchInPrinting.RequestLayout.nameAddress2Visble)
                PrintNameAddress(e, section.PrintRequest.Request, x + GetDPI(BatchInPrinting.RequestLayout.nameAddress2X), y + GetDPI(BatchInPrinting.RequestLayout.nameAddress2Y), 350, 110);

            if (BatchInPrinting.RequestLayout.accountNo1Visble)
                e.Graphics.DrawString(string.Format("{0}: {1}", GetAccountTypShotName(section.PrintRequest.AccountType), GetStrippedAccountNo(section.PrintRequest.Request)), font9, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo1X), y + GetDPI(BatchInPrinting.RequestLayout.accountNo1Y));

            if (BatchInPrinting.RequestLayout.accountNo2Visble)
                e.Graphics.DrawString(string.Format("{0}: {1}", GetAccountTypShotName(section.PrintRequest.AccountType), GetStrippedAccountNo(section.PrintRequest.Request)), font9, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo2X), y + GetDPI(BatchInPrinting.RequestLayout.accountNo2Y));

            var barcode = GetBarcode(GetStrippedAccountNo(section.PrintRequest.Request), 15, System.Drawing.RotateFlipType.RotateNoneFlipNone);
        ...
        private static void PrintBlankRequestSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo)
        {
            ...
            if (BatchInPrinting.RequestLayout.accountNo1Visble)
                e.Graphics.DrawString(string.Format("{0}: {1}", section.PrintRequest.AccountType.Name, GetStrippedAccountNo(section.PrintRequest.Request)), font7Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo1X), y + GetDPI(BatchInPrinting.RequestLayout.accountNo1Y));
            ...
            if (BatchInPrinting.RequestLayout.accountNo2Visble)
                e.Graphics.DrawString(string.Format("{0}: {1}", section.PrintRequest.AccountType.Name, GetStrippedAccountNo(section.PrintRequest.Request)), font8Bold, brush, x + GetDPI(BatchInPrinting.RequestLayout.accountNo2X), y + GetDPI(BatchInPrinting.RequestLayout.accountNo2Y));
        ...
        private static void PrintChequeSection(PrintPageEventArgs e, PrintPage printPage, int sectionNo, string printChequeBookAuditText)
        {
            ...
            Font fontBold10 = new Font("Verdana", 10, FontStyle.Bold);

            Font micrFont = new Font("MICR65", 12, FontStyle.Bold);
            Font IFSCFont = new Font("Consolas", 8);
            ...
            if (BatchInPrinting.ChequeLayout.ifscVisble)
                e.Graphics.DrawString(string.Format("RTGS/NEFT IFSC Code RTGS:- {0}", section.PrintRequest.Branch.IFSC), font9, brush, x + GetDPI(BatchInPrinting.ChequeLayout.ifscX), y + GetDPI(BatchInPrinting.ChequeLayout.ifscY));
            ...
            if (BatchInPrinting.ChequeLayout.accountNoVisble)
                e.Graphics.DrawString(string.Format("{0}:  {1}", GetAccountTypShotName(section.PrintRequest.AccountType), GetStrippedAccountNo(section.PrintRequest.Request)), font10, brush, x + GetDPI(BatchInPrinting.ChequeLayout.accountNoX), y + GetDPI(BatchInPrinting.ChequeLayout.accountNoY));
