namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "802", Name = "The Surendranagar District Co-op. Bank Ltd.", AddressLine1 = "Head Office, Surendranagar", City = "Surendranagar", State = "Gujarat", Country = "India", PostalCode = "363001", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
