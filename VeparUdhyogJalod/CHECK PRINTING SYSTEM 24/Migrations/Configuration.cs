namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "813", Name = "The Vepar Udhyog Vikas Sahakari Bank Ltd. Jholod.", AddressLine1 = " Near Limdi Darwaja", AddressLine2 = "", AddressLine3 = "", City = "Jhalod", State = "Gujarat", Country = "India", PostalCode = "389170", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
