...
namespace CPS.Business
{
    ...
    public class RequestBase : BaseEntity
    {
        ...
        [Display(Name = "BSR Code", Order = 28)]
        [Parse(5)]
        public string BSRCode { get; set; }
        [Display(Name = "BSR Code", Order = 29)]        
        ...
        [Display(Name = "Name", Order = 7)]
        [Required]
        [Parse(9)]
        public string Name { get; set; }

        [Display(Name = "Joint Name 1", Order = 8)]
        [Parse(10)]
        public string JointName1 { get; set; }

        [Display(Name = "Joint Name 2", Order = 9)]
        [Parse(11)]
        public string JointName2 { get; set; }

        [Display(Name = "Signatory 1", Order = 10)]
        [Parse(12)]
        public string Signatory1 { get; set; }

        [Display(Name = "Signatory 2", Order = 11)]
        [Parse(13)]
        public string Signatory2 { get; set; }

        [Display(Name = "Signatory 3", Order = 12)]
        [Parse(14)]
        public string Signatory3 { get; set; }

        [Display(Name = "Address 1", Order = 13)]
        [Parse(15)]
        public string Address1 { get; set; }

        [Display(Name = "Address 2", Order = 14)]
        [Parse(16)]
        public string Address2 { get; set; }

        [Display(Name = "Address 3", Order = 15)]
        [Parse(17)]
        public string Address3 { get; set; }

        [Display(Name = "Address 4", Order = 16)]
        [Parse(18)]
        public string Address4 { get; set; }

        [Display(Name = "Address 5", Order = 17)]
        [Parse(19)]
        ...
        [Display(Name = "Home Phone", Order = 41)]
        [Parse(22)]
        public string tele_r_no { get; set; }

        [Display(Name = "Mobile No", Order = 20)]
        [Parse(23)]
        public string mobile_no { get; set; }

        [Display(Name = "Office Phone", Order = 30)]
        [Parse(24)]
        public string tele_o_no { get; set; }

        [Display(Name = "No of ChqBook", Order = 21)]
        [Required]
        [Parse(25)]
        public int NoOfChequeBook { get; set; }

        [Required]
        [Display(Name = "No of Cheque", Order = 22)]
        [Parse(26)]
        ...
        [Display(Name = "A/C No Full", Order = 27)]
        [Required]
        [Parse(7)]
    ...
    public class ImportRequest
    {
        ...
        public bool Load(string filePath)
        {
            ...
            {
                if (lines[i] == ",,,,,,,,,,,,,,,,,,,,,,,,,,,,," || string.IsNullOrEmpty(lines[i])) continue;
