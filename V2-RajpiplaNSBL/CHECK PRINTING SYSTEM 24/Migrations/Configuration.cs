namespace CPS.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CPS.CPSDbContext>
    {
        ...
        protected override void Seed(CPS.CPSDbContext context)
        {
            ...
            context.BankMaster.AddOrUpdate(new BankMasterDTO { Id = 1, Code = "804", Name = "RAJPIPLA NAGRIK SAHAKARI BANK LTD.", AddressLine1 = "STATION ROAD RAJPIPLA. 393145. DIST. NARMADA", City = "RAJPIPLA", State = "GUJARAT", Country = "INDIA", PostalCode = "393145", CreatedBy = "default", CreatedOn = DateTime.Now, UpdatedBy = "default", UpdatedOn = DateTime.Now });
